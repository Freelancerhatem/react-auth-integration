...
const SignIn = () => {
  ...
  <div className="flex flex-col gap-4 p-6">
    ...
    <div className="relative h-11 w-full min-w-[200px]">
      ...
      <button className="btn-sm absolute bottom-[6px] right-2  bg-gradient-to-tr from-pink-600 to-pink-400 text-white rounded-md">Show</button>
    </div>
  ...
  <div className="p-6 pt-0">
    ...
    <button className="btn bg-gradient-to-tr from-pink-600 to-pink-400 text-white" onClick={googleLogin}>Google</button>
  </div>
  </form>
</div>
        </div>
